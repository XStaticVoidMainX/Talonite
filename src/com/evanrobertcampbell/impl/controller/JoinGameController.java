 ...
 */
public class JoinGameController extends BaseController implements Initializable
{
	...
	public void initialize(URL arg0, ResourceBundle arg1)
	{
		...
		hostNameTextField.setText((String) sessionVars.get(SessionVariableKeys.HOST_NAME));
...
//		thread.start();
	...
	public void PersistData()
	{
		...
		sessionVars.put(SocketUtils.IS_HOST, false);
